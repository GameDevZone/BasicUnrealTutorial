...
{
	//DrawDebugLine(GetWorld(), GetLineTraceStartVector(), GetLineTraceEndVector(), FColor(255, 0, 0), false, -1.f, 0.f, 10.f);
...
FVector UGrabber::GetLineTraceStartVector()
{
